...
ggScatter.default=function(x,yvar,xvar,colorvar=NULL,fillvar=NULL,facetvar=NULL,
                           se=TRUE,method="auto",fullrange=FALSE,maxfactorno=6,
    ...
    #
        ...
        p<-ggplot(data,aes_string(x=x,y=y,color=colorvar,fill=fillvar))+
            stat_smooth(method=method,se=se,fullrange=fullrange)+geom_point_interactive(aes(data_id=id,tooltip=tooltip),...)
