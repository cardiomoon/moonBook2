...
ggScatter(NTAV~age|smoking,data=radial,fullrange=TRUE,se=FALSE,addloess=FALSE,interactive=TRUE)
ggScatter(NTAV~age|DM,data=radial,fullrange=TRUE,se=TRUE,addloess=FALSE,interactive=TRUE)
```
